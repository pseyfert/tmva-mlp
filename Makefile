...
MYFLAGS=-O2 -g -Wall -Wextra -m64 -mabm -maes  -malign-stringops  -mavx  -mfancy-math-387  -mfentry  -mfp-ret-in-387  -mglibc  -mhard-float  -mieee-fp  -mlong-double-80  -msse  -msse2  -msse3 -ftree-vectorize -ftree-vectorize -ftree-vectorizer-verbose=7
